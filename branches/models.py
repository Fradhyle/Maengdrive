...
class Branch(models.Model):
    ...
    postcode = models.CharField(max_length=5, validators=[postcode_validator], verbose_name="우편번호")
    address1 = models.TextField(verbose_name="도로명 주소")
    address2 = models.TextField(verbose_name="상세 주소")
    phone1 = models.CharField(max_length=13, validators=[phone_validator], verbose_name="전화번호 1")
    phone2 = models.CharField(max_length=13, validators=[phone_validator], verbose_name="전화번호 2")
    is_running = models.BooleanField(default=True, verbose_name="운영 여부")
